...
export function Table<T extends Record<string, any>>({
  ...
  return (
    <div className={cn('w-full rounded-[10px] border border-slate-200 bg-white overflow-hidden flex flex-col', className)}>
              ...
              {columns.map((col) => {
                ...
                return (
                  <th
                    ...
                    className={cn(
                      'px-4 py-3 font-semibold uppercase tracking-wider text-slate-600 select-none',
