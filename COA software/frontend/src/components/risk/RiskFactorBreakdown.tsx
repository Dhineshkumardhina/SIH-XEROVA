        ...
        >
          <div className="flex justify-between items-center mb-1.5">
            <div className="flex items-center gap-2">
              <span className="font-semibold text-xs text-slate-200">{formatFactorName(f.factor)}</span>
              <span
            ...
            <div className="flex items-center gap-2 font-mono text-xs">
              ...
              <span className="font-bold text-slate-100">+{f.contribution.toFixed(1)}</span>
            </div>
          </div>
          ...
          <div className="w-full bg-slate-900 rounded-full h-1.5 mb-1.5 overflow-hidden">
            <div
              ...
              style={{ width: `${Math.min(100, Math.max(0, f.normalized_value))}%` }}
            />
          </div>

          <div className="flex justify-between text-[10px] text-slate-400 font-mono">
            <span>Raw: {String(f.raw_value)}</span>
            <span>Norm: {f.normalized_value.toFixed(0)}/100</span>
