...
export const DemoGuidedNav: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-slate-950/95 border-t border-blue-500/40 shadow-2xl backdrop-blur-md px-4 sm:px-6 py-2.5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3">
          
          {/* Left: Step Info & Current/Next Details */}
          <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-start">
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-blue-500/15 border border-blue-400/40 text-blue-400 text-[10px] font-mono font-bold uppercase tracking-wider">
            ...
            <div className="text-left">
              ...
              <p className="hidden lg:block text-[11px] text-slate-400 truncate max-w-sm">
          ...
          <div className="hidden xl:flex items-center gap-1 bg-slate-900/80 px-2.5 py-1 rounded-xl border border-slate-800">
          ...
          <div className="flex items-center gap-2.5 w-full md:w-auto justify-end">
            {nextStepItem && (
              <div className="hidden sm:flex flex-col text-right mr-1">
                <span className="text-[9px] uppercase font-mono text-slate-400 tracking-wider">Next</span>
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-semibold flex items-center gap-1 transition-all cursor-pointer ${
                isFirstStep
                  ? 'opacity-40 bg-slate-900 border border-slate-800 text-slate-600 cursor-not-allowed'
            ...
            <button
              ...
              className="px-4 py-1.5 rounded-lg text-xs font-bold bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white shadow-md hover:shadow-blue-500/20 border border-blue-400/40 flex items-center gap-1.5 transition-all cursor-pointer"
            >
            ...
            <button
              ...
              className="px-2.5 py-1.5 rounded-lg text-xs font-semibold bg-slate-900 hover:bg-red-950/60 text-slate-400 hover:text-red-300 border border-slate-800 hover:border-red-500/40 flex items-center gap-1 transition-all cursor-pointer"
            >
